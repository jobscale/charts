...
object generated {
  def main(args:Array[String]) {
    //autocreation of SparkSession so that it works like spark-shell in Analyze
    LogManager.getRootLogger.info("Creating spark as SparkSession")
    val spark = SparkSession.builder().enableHiveSupport().getOrCreate()
    LogManager.getRootLogger.info("Setting sc as SparkContext")
    val sc = spark.sparkContext

    try {
      val sqlQuery ="""SET SCHEME=s3;
                     SET BASE_BUCKET=joylalchattaraj;
                     SET file_format_type=parquet;
                     SET SCALE=1000;
                     SET full_existing_table_loc=s3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/;
                     DROP DATABASE IF EXISTS tpcds_scale_3000_parquet_non_cbo_joyc CASCADE;
                     CREATE DATABASE IF NOT EXISTS tpcds_scale_3000_parquet_non_cbo_joyc;
                     USE tpcds_scale_3000_parquet_non_cbo_joyc;
                     ...
                     dv_cmdline_args string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/dbgen_version/';
                     ...
                     c_last_review_date string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/customer';
                     ...
                     ca_location_type string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/customer_address';
                     ...
                     cd_dep_count int , cd_dep_employed_count int , cd_dep_college_count int) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/customer_demographics';
                     ...
                     d_current_year string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/date_dim';


                     DROP TABLE IF EXISTS household_demographics;
                     CREATE EXTERNAL TABLE household_demographics ( hd_demo_sk bigint , hd_income_band_sk bigint , hd_buy_potential string ,
                     hd_dep_count int , hd_vehicle_count int) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/household_demographics';


                     DROP TABLE IF EXISTS income_band;
                     CREATE EXTERNAL TABLE income_band ( ib_income_band_sk bigint , ib_lower_bound int , ib_upper_bound int) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/income_band';
                     ...
                     i_units string ,
                     i_container string ,
                     i_manager_id int , i_product_name string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/item';
                     ...
                     p_purpose string ,
                     p_discount_active string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/promotion';


                     DROP TABLE IF EXISTS reason;
                     CREATE EXTERNAL TABLE reason ( r_reason_sk bigint , r_reason_id string ,
                     r_reason_desc string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/reason';
                     ...
                     sm_code string ,
                     sm_carrier string ,
                     sm_contract string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/ship_mode';
                     ...
                     s_tax_precentage decimal(5,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/store';
                     ...
                     t_shift string ,
                     t_sub_shift string ,
                     t_meal_time string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/time_dim';
                     ...
                     w_zip string ,
                     w_country string ,
                     w_gmt_offset decimal(5,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/warehouse';
                     ...
                     web_tax_percentage decimal(5,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/web_site';
                     ...
                     wp_type string ,
                     wp_char_count int , wp_link_count int , wp_image_count int , wp_max_ad_count int) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/web_page';


                     DROP TABLE IF EXISTS inventory;
                     CREATE EXTERNAL TABLE inventory ( inv_date_sk bigint , inv_item_sk bigint , inv_warehouse_sk bigint , inv_quantity_on_hand int) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/inventory';
                     ...
                     sr_net_loss decimal(7,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/store_returns';
                     ...
                     ws_net_profit decimal(7,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/web_sales';
                     ...
                     wr_net_loss decimal(7,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/web_returns';
                     ...
                     cc_tax_percentage decimal(5,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/call_center';
                     ...
                     cp_type string) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/catalog_page';
                     ...
                     cr_net_loss decimal(7,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/catalog_returns';
                     ...
                     cs_net_profit decimal(7,2)) STORED AS parquet LOCATION 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/catalog_sales';
                     ...
                     ) STORED AS parquet location 's3a://joylalchattaraj/perfk8s/data/tpcds/parquet/scale_3000/store_sales'
      		     """
      val queries = sqlQuery.split(";");
      for (q <- queries) {
        println(q)
        spark.sql(q)
      }
      val df1 = spark.sql("show tables");
      df1.show()
